...
export default async function seed() {
    await db.insert(Herbs_db).values([
        ...
        },
        {
            name_herbs: "Chaga",
            available: false,
            paragraph: "Beneficios de Chaga",
            key_points: "Apoya los sistemas inmunológicos y digestivos, Mejor la apariencia de la piel y el cabello, Apoya en desintoxicación corpora, Ayuda a aliviar tensión,Soporta niveles saludables de Azúcar en la sangre,Corta circulación a tumores",
        },
        {
            name_herbs: "Sananga",
            available: false,
