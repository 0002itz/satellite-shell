...
export default async function seed() {
    await db.insert(Herbs_db).values([
        {
            ...
            imagePath:`/src/assets/Melena de León.png`,
            available: true,
        ...
        },
        {
            ...
            imagePath:`/src/assets/Cordyceps.png`,
            available: true,
        ...
        {
            product_name: "Chaga",
            imagePath:`/src/assets/Chaga.png`,
            available: false,
        ...
        },
        {
            ...
            imagePath:`/src/assets/Sananga.png`,
            available: false,
    ...
    await db.insert(Ceremonis_db).values([
        {
            product_name: "Xanga",
            imagePath:`/src/assets/Xanga.png`,
        ...
        },
        {
            ...
            imagePath:`/src/assets/Bufo alvarius.png`,
        ...
        {
            product_name: "kambô",
            imagePath:`/src/assets/kambô.png`,
